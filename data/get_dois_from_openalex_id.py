...
def get_dois_from_openalex(institute_id):
    ...
    for page in range(1, nr_pages + 1):
        response = requests.get(base_url, params={
            ...
            'per_page': 200,
            'mailto': 'tobias.gottschall@lin-magdeburg.de'
        })
        data = response.json()
...
if __name__ == "__main__":
    main()
## restrict findings for year:
## https://api.openalex.org/works?page=1&filter=authorships.institutions.lineage:i4387155373,publication_year:2025&sort=cited_by_count:desc&per_page=10
